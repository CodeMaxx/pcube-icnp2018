...
def handle_pkt(pkt):
    ...
    rfile = open(dirpath+"/INT_udp_flows_results.txt","a")
    #print("got a packet")
    #print("pkt length=")
    #print(len(pkt))
    # pkt.show2()
    ...
    if(sys.argv[1]=="10.0.2.15"):
        ...
        # write logic for finding max occuring element from list
            ...
            if (result[1] > len(l)/3): # if the count of max repeating element exceeds 1/3rd of the len(list) we assume it is a heavy flow
