...
class UDPFlow(threading.Thread):
	...
	def run(self):
		...
		if threadID == 2 :
			...
			print("total_packets_sent_thread3 = ",total_packets_sent_thread1)
...
def main():
	...
	print("total_packets_sent_thread2 in main = ",total_packets_sent_thread3)
	print("total packets sent overall = ",total_packets_sent_thread1+total_packets_sent_thread2+total_packets_sent_thread3)
