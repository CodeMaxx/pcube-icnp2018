...
for i in range(1,9):
	...
	# for SOURCE_PORT in range(56000):
		...
		if i == 7:
			...
			command_to_write2 = "table_add ipv4_lpm ipv4_forward 10.0.8.2/32 "+str(SOURCE_PORT)+" "+str(DST_PORT)+" => 00:00:00:00:08:02 5"
		elif i == 8 :
			command_to_write1 = "table_add ipv4_lpm ipv4_forward 10.0.1.1/32 8080 "+str(SOURCE_PORT)+" => 00:00:00:00:01:01 2"
			command_to_write2 = "table_add ipv4_lpm ipv4_forward 10.0.8.2/32 "+str(SOURCE_PORT)+" "+str(DST_PORT)+" => 00:00:00:00:08:02 1"
		# i= 1 to 6
		else :
			command_to_write1 = "table_add ipv4_lpm ipv4_forward 10.0.1.1/32 8080 "+str(SOURCE_PORT)+" => 00:00:00:00:01:01 1"
			command_to_write2 = "table_add ipv4_lpm ipv4_forward 10.0.8.2/32 "+str(SOURCE_PORT)+" "+str(DST_PORT)+" => 00:00:00:00:08:02 2"
